...
# origins = ["http://localhost:5173"]  # tighten CORS for dev
# app.add_middleware(
#     CORSMiddleware,
...
# # If you enabled permissions in Auth0, you can enforce them like:
# # user=Depends(require_scopes(["predict:read"]))
...
#     writer.writerow(["Image URL", "Result", "Confidence", "Timestamp"])
#     for r in records:
#         writer.writerow([r.get("image_url", ""), r.get("result", ""), r.get("confidence", ""), r.get("timestamp", "")])
#     output.seek(0)
