...
## ☁️ Deployment
- **Frontend:** Deployed on [Vercel](https://vercel.com/) with SSL support  
- **Backend:** Deployed on [Render](https://render.com/) using FastAPI  
...
🔗 **Live Website:** [AgroCare AI (SeedSyncAI)](https://seedsyncai.vercel.app/)
